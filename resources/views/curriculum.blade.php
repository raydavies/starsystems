	...
	<div id="curriculum-tour" class="carousel slide margin-top-15" data-interval="false">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item row clearfix active">
				<img src="{{ asset('/img/curriculum/screen_math_sm.jpg') }}" alt="..." class="col-md-6">
			...
			<div class="item row clearfix">
				<img src="{{ asset('/img/curriculum/study_math_sm.jpg') }}" alt="..." class="col-md-6">
				<div class="col-md-6 caption">
			...
			<div class="item row clearfix">
				<img src="{{ asset('/img/curriculum/practice_math_sm.jpg') }}" alt="..." class="col-md-6">
				<div class="col-md-6 caption">
			...
			<div class="item row clearfix">
				<img src="{{ asset('/img/curriculum/recess_math_sm.jpg') }}" class="col-md-6">
				<div class="col-md-6 caption">
			...
			<div class="item row clearfix">
				<img src="{{ asset('/img/curriculum/essay_math_sm.jpg') }}" alt="..." class="col-md-6">
				<div class="col-md-6 caption">
			...
			<div class="item row clearfix">
				<img src="{{ asset('/img/curriculum/test_math_sm.jpg') }}" alt="..." class="col-md-6">
				<div class="col-md-6 caption">
			...
			<div class="item row clearfix">
				<iframe height="405" src="https://www.youtube.com/embed/K8mcfFUghf0?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen class="col-md-6 video-slide"></iframe>
				<div class="col-md-6 caption">
